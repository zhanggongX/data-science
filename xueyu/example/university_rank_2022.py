...
def get_page(url):
    ...
    # univUp:"tsinghua-university",univLogo:"logo\u002F27532357.png",univNameCn:"清华大学",univNameEn:"Tsinghua University",inbound:b,liked:b,univLikeCount:cy,univTags:[i,l,j],univNameRemark:a,univCategory:f,province:q,score:999.4,ranking:em,rankChange:c,rankOverall:em,indData:{"271":cz,"272":"73.6","273":en,"274":"51.7","275":"334.6","276":"101.3","277":cA,"278":"89.8","279":"126.8","280":"85.7"}
    per_universities_re = re.compile(
        '.*univNameCn:"(.*)",univNameEn:(.*?),.*univTags:(.*],?),.*univCategory:(.*),province:(.*),score:(.*),ranking:(.*),rankChange.*indData:{"271":(.*),"272":(.*),"273":(.*),"274":(.*),"275":(.*),"276":(.*),"277":(.*),"278":(.*),"279":(.*),"280":(.*)}',
        re.S)
...
if __name__ == '__main__':
    # 2022
    path = 'https://www.shanghairanking.cn/_nuxt/static/1723540750/rankings/bcur/202211/payload.js'
    ...
    df.to_excel('university_rank_2022.xlsx')
